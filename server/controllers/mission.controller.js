...
const createMission = async (req, res) => {
    ...
    try {
        ...
        const isPremium = abonnementCheck.rows.length > 0;
        ...
        if (parseInt(missionCount.rows[0].count) >= 3) {
            return res.status(403).json({
            message: 'Limite de 3 missions par mois atteinte. Passez à Premium pour publier des missions illimitées.',
